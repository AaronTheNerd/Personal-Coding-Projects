...
// Copyright 2019
#ifndef _TREE_DL_TESTING_CC_
#define _TREE_DL_TESTING_CC_
#include <iostream>
#include "../Forest/Tree.h"
#include "../Forest/DoublyLinkedTree.h"
#endif 

struct DL_TESTER {
  bool testDLTree(Tree<int>* t) {
    std::cout << "Testing Doubly Linked Tree" << std::endl;
    bool result = true;
