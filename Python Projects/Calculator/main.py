...
class Calculator(object):
  ...
  def bind(self):
    self.calc.focus_set()
    self.calc.bind('KP_7', lambda:self.push_current(7))
    self.calc.bind('KP_8', lambda:self.push_current(8))
    self.calc.bind('KP_9', lambda:self.push_current(9))
    self.calc.bind('KP_4', lambda:self.push_current(4))
    self.calc.bind('KP_5', lambda:self.push_current(5))
    self.calc.bind('KP_6', lambda:self.push_current(6))
    self.calc.bind('KP_1', lambda:self.push_current(1))
    self.calc.bind('KP_2', lambda:self.push_current(2))
    self.calc.bind('KP_3', lambda:self.push_current(3))
    self.calc.bind('KP_0', lambda:self.push_current(0))
