...
def run():
    ...
    os.system(f"convert -delay {GIF_CONFIGS['MS_PER_FRAME']} -loop 0 {ABS_PATH}/{GIF_CONFIGS['NUM']}/*.bmp -crop {CONFIGS['WIDTH']}x{CONFIGS['HEIGHT']}+{GIF_CONFIGS['MARGIN']}+{GIF_CONFIGS['MARGIN']} +repage {ABS_PATH}/{GIF_CONFIGS['NUM']}/gif{GIF_CONFIGS['NUM']}.gif")
    # Remove frames
